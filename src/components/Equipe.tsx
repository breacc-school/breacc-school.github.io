...
import antonioPhoto from "@/assets/equipe/antonio.png";
...
import marinaPhoto from "@/assets/professoras-photos/marina.jpg";
import lucasPhoto from "@/assets/professoras-photos/lucas.png";
import kellyPhoto from "@/assets/professoras-photos/kelly.jpg";
import laraPhoto from "@/assets/professoras-photos/lara.jpg";
import aliciaPhoto from "@/assets/professoras-photos/alicia.jpg";
import lilyPhoto from "@/assets/professoras-photos/lily.jpg";
...
const committeeData = [
  ...
  { key: "catia", name: "Catia Silva Leite", photo: catiaPhoto },
  { key: "antonio", name: "Antonio Campello", photo: antonioPhoto },
  { key: "michele", name: "Michele", photo: michelePhoto },
  { key: "rita", name: "Rita Dorneles", photo: ritaPhoto },
];

const teachersData = [
  { key: "marina", name: "Marina Raposo do Amaral Santos", photo: marinaPhoto },
  { key: "lucas", name: "Lucas Nunes", photo: lucasPhoto },
  { key: "cristina", name: "Cristina Artuzo", photo: null },
  { key: "kelly", name: "Kelly Saldanha", photo: kellyPhoto },
  { key: "lara", name: "Lara Olivatti", photo: laraPhoto },
  { key: "alicia", name: "Alicia Brumpton", photo: aliciaPhoto },
  { key: "lily", name: "Lily Gallo", photo: lilyPhoto },
  { key: "maria_luiza", name: "Maria Luiza Dos Reis Aguiar Tebas", photo: null },
];
